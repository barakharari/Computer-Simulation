...
public class Job {
	...
	public void setStartcodeIndex(int aStartcodeIndex) {
		this.startcodeIndex = aStartcodeIndex;
	}
	...
	public void setStartmemoryIndex(int aStartmemoryIndex) {
		this.startmemoryIndex = aStartmemoryIndex;
	}
